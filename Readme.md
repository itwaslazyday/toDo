...
[ToDo App](https://mindbox-todo-itwaslazyday.vercel.app/) - персональный органайзер дел и пометок для выполнения. В приложении реализован следующий функционал:

- приложение создано с использованием TypeScript, React и React Hooks (useState), React Testing Library/Jest. Другие библиотеки не использовались;
